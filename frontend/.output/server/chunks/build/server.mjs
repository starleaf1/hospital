...
const __nuxt_page_meta = {
  layout: false
  // Do not use the dashboard layout for login page
};
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-Btpsxh40.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: __nuxt_page_meta || {},
    component: () => import('./login-DW-5OpIB.mjs')
  },
  {
    name: "patients",
    path: "/patients",
    component: () => import('./patients-Ko8o84rz.mjs')
  },
  {
    name: "settings",
    path: "/settings",
    component: () => import('./settings-DaV9eNIg.mjs')
  },
  {
    name: "appointments",
    path: "/appointments",
    component: () => import('./appointments-DoXiTzDI.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-lWbLz41X.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CW-RXzzD.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CdaOlI4_.mjs'));
